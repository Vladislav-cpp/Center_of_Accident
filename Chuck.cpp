		...
		position_X, position_Y)
{
	...
	float distance = sqrt(pow(direction_X - position_X, 2) + pow(direction_Y - position_Y, 2));

	Sprite_Player.setOrigin(0, image_height/2);


	direction_movement_X = (direction_X - position_X) / distance;//( direction_X - position_X )/ distance -
...
void Chuck::movement(float time)
{
	...
	if (position_X < 0 || position_X >2000) Set_life(0); //!!!!!!!!!!!!!!!!!!
	if (position_Y < 0 || position_Y >2000) Set_life(0); //!!!!!!!!!!!!!!!!!!
